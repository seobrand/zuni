...
class mailchimpComponent extends Object {
    ...
    var $apikey =  '20d166cc30a62a01a63b72a5d8ca8b2d-us7';//zuni20 //'caca69468a70bf2f4e3b2c53cb41212b-us7';//live  //'YOUR MAILCHIMP APIKEY';
    // A List Id to run examples against. use lists() to view all
    // Also, login to MC account, go to List, then List Tools, and look for the List ID entry
    var $listId = ''; //'YOUR MAILCHIMP LIST ID - see lists() method';
    
    // A Campaign Id to run examples against. use campaigns() to view all
    var $campaignId = ''; //'YOUR MAILCHIMP CAMPAIGN ID - see campaigns() method';

    //some email addresses used in the examples:
    var $my_email = 'INVALID@example.org';//'4007@dothejob.org';//
    var $boss_man_email = 'INVALID@example.com';//'105dv@dothejob.org';//

    //just used in xml-rpc examples
    var $apiUrl = 'http://api.mailchimp.com/1.3/';
    ...
    */
     ...
     * @returnf array data the data for each member, including:
            ...
            string reason_text For unsubscribes only - if the reason is OTHER, the text entered.
     */
    function listMembers($id, $status='subscribed', $since=NULL, $start=0, $limit=500) {
        $params = array();
        $params["id"] = $id;
        $params["status"] = $status;
        $params["since"] = $since;
