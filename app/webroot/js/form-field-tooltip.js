...
Constructor 
**/
function DHTMLgoodies_formTooltip(sdfsdfsd)
{
	var tooltipDiv;
	var tooltipText;
	...
	this.imagePath = sdfsdfsd+'app/webroot/img/';
...
DHTMLgoodies_formTooltip.prototype = {
	...
	initFormFieldTooltip : function()
	{
		...
		this.addEvent(document.documentElement,'mouseover',function(e){ window.refToFormTooltip.__autoHideTooltip(e); });
	}
	...
	__displayTooltip : function()
	{
		...
		DHTMLgoodies_globalTooltipObj.tooltipContentDiv.innerHTML = '<font color="#ffffff">'+tooltipText+'</font>';
	...
	__createTooltip : function()
	{
		...
		closeDiv.innerHTML = '<A class="DHTMLgoodies_formTooltip_closeMessage" href="#" onclick="DHTMLgoodies_globalTooltipObj.__hideTooltipFromLink();return false"><font color="#ffffff">' + this.closeMessage + '</font></A>';
		
		if(this.disableTooltipPossibility){
			var tmpHTML = closeDiv.innerHTML;
			tmpHTML = tmpHTML + ' <A class="DHTMLgoodies_formTooltip_closeMessage" href="#" onclick="DHTMLgoodies_globalTooltipObj.disableTooltip();return false"><font color="#ffffff">' + this.disableTooltipMessage + '</font></A>';
