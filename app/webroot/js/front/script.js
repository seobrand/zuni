...
if(isChrome) {
   ...
   $("span.selected").css({"padding":"7px 0 0"});
...
if(isSafari) {
   ...
   $("span.selected").css({"padding":"7px 0 0"});
   $(".selectmenu").css({"line-height":"28px"});
   $(".inputOuter2 input").css({"line-height":"28px","margin":"7px 0 0 8px"});
...
$(".show_link").click(function() {	
	$(this).hide();
	$(".copyright").css({'padding-bottom':'90px'});
	$(".joinZuni").slideDown(1200);	 
