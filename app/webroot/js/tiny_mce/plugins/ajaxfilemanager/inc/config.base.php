...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_EDITABLE_VALID_EXTS', 'txt,htm,html,xml,js,css,xls,xlsx'); //make you include all these extension in CONFIG_UPLOAD_VALID_EXTS if you want all valid
