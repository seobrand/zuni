...
$connection_ticket = 'TGT-187-9tcVn8pclUeTzqVtSoQVhQ';
...
{
$Transaction = $MS->charge($Card, $amount);
	print('Card charged!' . "\n");
	print_r($Transaction);
